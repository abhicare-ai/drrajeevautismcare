...
export default function VavBorder() {
  return (
    <div>
       <div className=" bottom-0 left-0 w-full rotate-180 overflow-hidden leading-[0]">
      <svg viewBox="0 0 1200 120" preserveAspectRatio="none" className="h-[200px] w-full">
        <path
